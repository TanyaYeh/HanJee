...
<link
	href="https://fonts.googleapis.com/css?family=Merriweather:900|Noto+Sans"
	rel="stylesheet">
<link rel="stylesheet"
...
.card.is-active .cardContent_back h2, .card.is-active .cardContent_back fieldset,
	.card.is-active .cardContent_back .wrap {
	opacity: 1;
}
...
<body translate="no" style="background-color: #91ced4;">
...
<div style="margin-top:500">
	<main id="main" class="main" role="main">
<!-- 		<div class="card"> -->
<!-- 			<h2>文章明細</h2> -->
			<section class="container" >
				<div class="card_content" style="margin-top:500">
					<div class="cardContent_main">

						<div class="img_center">
							<img
								src="<c:url value='/tw/hanjee/getPicture/${post.post_no}' />" />
						</div>
						<p>
						<h3 style="font-size: 28px">標題:${post.post_tit}</h3>
						<p>作者: ${post.mb.nickname}<p style="font-size: 23px">
						</p><p style="font-size: 23px">時間: ${post.post_time}</p>

						<p style="font-size: 22px">文章內容: ${post.post_content}</p>
					</div>
				</div>
				...
				<div id="commentArea" style="font-size: 20px">
				...
				<!-- 				</table> -->
				<p>
					<a href="<c:url value='/tw/hanjee/PostUpdate/${post.post_no}' />"
						style="font-size: 25px"> 編輯</a>
				</p>
...
<!-- 		</div> -->
	...
	<script
		src="https://cpwebassets.codepen.io/assets/editor/iframe/iframeRefreshCSS-bb9a2ba1f03f6147732cb3cd52ac86c6b24524aa87a05ed0b726f11e46d7e277.js"></script>
