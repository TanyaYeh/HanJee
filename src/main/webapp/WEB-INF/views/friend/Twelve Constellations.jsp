...
<body style="background-color:#E6EBDF ">
	...
	<div class="flex-container">
		<div class="item">
			...
			<a href="<c:url value='/getConDetailInf/0' />" title="牡羊座"><img
				src="<c:url value='images/牡羊座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♈牡羊座</p>
			<p>3月21日 - 4月19日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/1' />" title="金牛座"><img
				src="<c:url value='images/金牛座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♉金牛座</p>
			<p>4月20日 - 5月20日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/2' />" title="雙子座"><img
				src="<c:url value='images/雙子座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♊雙子座</p>
			<p>5月21日 - 6月20日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/3' />" title="巨蟹座"><img
	...
	<div class="flex-container">
		<div class="item">
			<a href="<c:url value='/getConDetailInf/4' />" title="獅子座"><img
				src="<c:url value='images/獅子座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♌獅子座</p>
			<p>7月23日 - 8月22日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/5' />" title="處女座"><img
				src="<c:url value='images/處女座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♍處女座</p>
			<p>8月23日 - 9月22日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/6' />" title="天秤座"><img
				src="<c:url value='images/天秤座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♎天秤座</p>
			<p>9月23日 - 10月22日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/7' />" title="天蠍座"><img
	...
	<div class="flex-container">
		<div class="item">
			<a href="<c:url value='/getConDetailInf/8' />" title="射手座"><img
				src="<c:url value='images/射手座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♐射手座</p>
			<p>11月22日 - 12月21日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/9' />" title="摩羯座"><img
				src="<c:url value='images/摩羯座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♑摩羯座</p>
			<p>12月22日 - 1月19日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/10' />" title="水瓶座"><img
				src="<c:url value='images/水瓶座.jpg' />" alt="測試圖片" border="0"></a>
			<p class="title">♒水瓶座</p>
			<p>1月20日 - 2月18日</p>
		</div>
		<div class="item">
			<a href="<c:url value='/getConDetailInf/11' />" title="雙魚座"><img
